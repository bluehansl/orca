...
function removePersistentWebview(browserTabId: string, preserveZoom: boolean): Promise<void> {
  const webview = webviewRegistry.get(browserTabId)
  if (!preserveZoom) {
...
export function destroyPersistentWebview(browserTabId: string): Promise<void> {
  return removePersistentWebview(browserTabId, false)
}

export function replacePersistentWebview(browserTabId: string): Promise<void> {
  return removePersistentWebview(browserTabId, true)
}
